/**
 * Home page component
 * Displays the list of events with filtering and search capabilities
      ...
      <div className="px-4 py-8">
        <div className="max-w-7xl mx-auto">
          <Fragment>
            ...
            <div className={`flex flex-col items-center ${hasSearchQuery ? 'mb-8 pt-24' : 'mb-16 pt-32'}`}>
              <div className="w-full max-w-3xl">
                ...
                <DesktopWindow title="Search & Filter">
                  <div>
                    ...
                    <div className="input-container">
                      <input
                        ...
                        placeholder="Search by name, description, or speaker..."
                ...
                {/* Walking Animation - Only show when no search */}
                {!hasSearchQuery && (
            ...
            {/* Event Cards - Always visible, moves up when searching */}
            <div id="events-section" className={hasSearchQuery ? 'mt-8' : 'mt-16'}>
